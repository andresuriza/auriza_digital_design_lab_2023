    ...
    ldr r7, =0xAA         // Carga el valor de espacio (0xAA) en r7
...
incrementar_direccion:
    add r0, r0, #16        // Incrementa la dirección en r0 en 1 (un byte)
...
reset_contador:
    ...
    add r0, r0, #16       // Incrementa la dirección en r0 en 16 bytes
